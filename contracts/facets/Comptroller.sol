...
contract Comptroller is Pausable, IComptroller {
    ...
    function updateLoanIssuanceFees(uint256 fees) external override authComptroller returns (bool) {
        AppStorageOpen storage ds = LibOpen.diamondStorage();
    ...
    function updateLoanClosureFees(uint256 fees) external override authComptroller returns (bool) {
        AppStorageOpen storage ds = LibOpen.diamondStorage();
    ...
    function updateLoanPreClosureFees(uint256 fees) external override authComptroller returns (bool) {
        AppStorageOpen storage ds = LibOpen.diamondStorage();
    ...
    function updateWithdrawalFees(uint256 fees) external override authComptroller returns (bool) {
        AppStorageOpen storage ds = LibOpen.diamondStorage();
    ...
    function updateCollateralReleaseFees(uint256 fees) external override authComptroller returns (bool) {
        AppStorageOpen storage ds = LibOpen.diamondStorage();
    ...
    function updateYieldConversion(uint256 fees) external override authComptroller returns (bool) {
        AppStorageOpen storage ds = LibOpen.diamondStorage();
    ...
    function updateMarketSwapFees(uint256 fees) external override authComptroller returns (bool) {
        AppStorageOpen storage ds = LibOpen.diamondStorage();
    ...
    function updateReserveFactor(uint256 _reserveFactor) external override authComptroller returns (bool) {
    ...
    function updateMaxWithdrawal(uint256 factor, uint256 blockLimit) external override authComptroller returns (bool) {
        AppStorageOpen storage ds = LibOpen.diamondStorage();
