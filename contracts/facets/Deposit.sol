...
contract Deposit is Pausable, IDeposit {
    ...
    function accruedYield(
        ...
        (yield.oldLengthAccruedYield, yield.oldTime, aggregateYield) = LibOpen._calcAPY(
            _commitment,
    ...
    function getFairPriceDeposit(uint256 _requestId) external view override returns (uint256) {
